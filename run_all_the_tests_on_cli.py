...
if __name__ == "__main__":
    ...
    all_test_cases: Tuple[TestCase, ...] = (
        ...
        TestCase.gen_test_case(
            gen_test_case_path("test_utils.py"), wait_between_test_types=True
        ),
        TestCase.gen_test_case(
            gen_test_case_path("test_file_utils.py"), wait_between_test_types=True
        ),
        TestCase.gen_test_case(gen_test_case_path("test_package.py")),
        TestCase.gen_test_case(
            gen_test_case_path("test_the_project_main_reusable_func.py")
        ),
