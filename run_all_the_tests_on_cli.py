...
from run_all_the_tests import TestCase, TestCasePath, run_all_tests, Group
...
if __name__ == '__main__':
    ...
    all_test_cases: Tuple[TestCase, ...] = (
        ...
        TestCase.gen_test_case(gen_test_case_path('test_utils.py'), Group.TWO),
        TestCase.gen_test_case(gen_test_case_path('test_file_utils.py'), Group.THREE),
